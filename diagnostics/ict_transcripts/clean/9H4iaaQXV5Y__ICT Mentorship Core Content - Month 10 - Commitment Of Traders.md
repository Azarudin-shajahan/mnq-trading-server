---
title: "ICT Mentorship Core Content - Month 10 - Commitment Of Traders"
video_id: 9H4iaaQXV5Y
url: https://www.youtube.com/watch?v=9H4iaaQXV5Y
source: InnerCircleTrader
---

# ICT Mentorship Core Content - Month 10 - Commitment Of Traders

so can we talk about the commodity
...
that long column you'll see that there
is
450 contracts that's the commercial long
positions
and then to the right of that underneath
the short column it's 76 426 contracts
...
what they're doing as a hedger
...
back a year to see what they've done the
highest
...
at it so let's take a look at it closer
now
...
but for optimal trade conditions for
entries
...
short and the activity of their net
positions
...
price was doing the whole first half of
2016.
...
or February 2016 when price made that
low
...
programs are so while they had a cell
...
going above the zero so while they have
...
greatest in advances in price going
higher
...
outlined here as a basis for that
...
below the zero line the best conditions
are
...
we can see how price went back to the
