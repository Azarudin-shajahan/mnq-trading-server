...
mentors: [
 {id:"ttrades", name:"TTrades", owns:"owns BIAS",
  ...
  setups:[["Fractal Model C2 Reversal (TTFM)","a"],["IC-CISD (Intracandle CISD)","a"],["Unicorn (Breaker + FVG)","a"],["TTFM Continuation (Candle 3/4)","a"]],
 ...
 {id:"dayement", name:"Daye Mentorship", owns:"the QT MENTORSHIP",
  ...
  setups:[["Two-Stage Sequential SMT (One Shot One Kill)","r"],["Stage-4 (Advanced 4-Stage) Setup","r"],["Monday Expansion Model","a"],["CPI Trading Model","a"],["Q4 Afternoon Reversal (Mentorship)","a"]],
 ...
 {id:"gxt", name:"GxT", owns:"owns ENTRY",
  ...
  setups:[["6:00 AM NY Reversal → 10:00 AM Continuation","a"],["NY AM V-Shape Reversal","s"],["Driver Pairing","r"],["Lagging-Asset SMT (Asset Synchronization)","r"]],
 ...
 {id:"dexter", name:"Dexter", owns:"owns TARGETS",
  ...
  setups:[["4H Power-of-Three Expansion","a"],["Market Maker Buy/Sell (MMXM)","a"],["Tuesday Reversal Profile","a"],["High-Impact News (NFP & JOLTS)","a"],["Silver Bullet Zone Continuation","a"],["Devil's Mark Reversal","a"]],
 ...
 {id:"xyj", name:"XYJ", owns:"the MMXM SYNTHESIS",
  ...
  setups:[["Lathyrus 80% Model (ERL↔IRL)","r"],["2-Stage CiC True Reversal","r"],["MMXM Continuation (Type 1)","a"],["Strength-Switch / Lagging-Asset","r"],["Seek & Destroy Session","a"],["Continuation Framework","a"]],
